...
function searchBox() {
  ...
  document
    .querySelector("#search button.close")
    .addEventListener("click", function (event) {
...
function headingAnimation() {
  const heading = document.querySelectorAll(".headingani");
  ...
  heading.forEach((text) => {
    ...
    let chars = text.querySelectorAll(`.headingani .char`);
    headingTl.from(chars, 1, {
      x: 50,
      autoAlpha: 0,
      stagger: 0.1,
